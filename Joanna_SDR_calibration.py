...
if __name__ == '__main__':
    ...
    for row in xrange(len(exp_df)):
        ...
        SDR_args = {
            ...
            u'ic_0_param': ic_0,
            u'k_param': k_param,
            u'lulc_uri': u'C:/Users/Ginger/Documents/NatCap/GIS_local/Joanna/LULC_Salinas_CalcStats2015May13/LULC_GK/ais05nlcd06.tif',
            u'results_suffix': run,
            u'sdr_max': u'0.8',
        ...
        summary_dict['run_%d' % run] = current_results
