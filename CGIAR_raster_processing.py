...
def summarize_mv_by_HRU():
    ...
    objectives = ['sdr', 'swy', 'swyl']
    for obj in objectives:
        raster_folder = "C:/Users/Ginger/Documents/NatCap/GIS_local/CGIAR/Peru/summarized_by_zone/%s_mv_rasters_6.2.16" % obj
        arcpy.env.workspace = raster_folder
        mv_rasters = arcpy.ListRasters()
        save_dir = "C:/Users/Ginger/Documents/NatCap/GIS_local/CGIAR/Peru/summarized_by_zone/%s_mv_rasters_mosaic_6.2.16" % obj
        ...
        mv_rasters = arcpy.ListRasters()
        HRU_outdir = "C:/Users/Ginger/Documents/NatCap/GIS_local/CGIAR/Peru/summarized_by_zone/%s_summary_tables_by_HRU_6.1.16" % obj
        if not os.path.exists(HRU_outdir):
            os.makedirs(HRU_outdir)
        summarize_by_zone(mv_rasters, HRU_zones, HRU_outdir)
        summary_csv = "C:/Users/Ginger/Documents/NatCap/GIS_local/CGIAR/Peru/summarized_by_zone/%s_mv_by_HRU_6.1.16.csv" % obj
...
if __name__ == "__main__":
    ...
    # mv_table = r"C:\Users\Ginger\Dropbox\NatCap_backup\CGIAR\Peru\Forage_model_results\marginal_5.2.16.csv"
    # subbasin_tif = r"C:\Users\Ginger\Documents\NatCap\GIS_local\CGIAR\Peru\boundaries\SWAT_subbasins.tif"
    # outdir = r"C:\Users\Ginger\Documents\NatCap\GIS_local\CGIAR\Peru\summarized_by_zone\livestock_mv_rasters_6.1.16"
